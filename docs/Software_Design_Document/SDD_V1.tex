...
\pagestyle{fancy}
\fancyhead[L]{AI-Powered Triage System - System Design Document (SDD) V.1}
...
\begin{itemize}
    \item The instructor and graders of the CS 3338 course.
...
The AI-Powered Triage System is a web-based healthcare tool that allows  authorized medical personnel to:
\begin{itemize}
    \item Log in securely.
    \item Access demographic and historical patient visit information.
    \item Receive AI-generated summaries and triage recommendations in future version systems. 
...
\begin{enumerate}
    ...
    \item The user views patient information and navigates through UI.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Passing data to/from the AI model in future versions
    \end{itemize}
    ...
    \item \textbf{AI Service Layer (Planned)}
    Connects to an AI model such as OpenAI GPT or a local machine learning model trained on healthcare text in future versions.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Main UI Pages}: Verified healthcare personnel can authenticate themselves through the Login Page. They can also view patients' demographics and visit history through the Patient Profile Page.
